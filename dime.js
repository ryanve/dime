...
(function (root, name, definition) {// github.com/umdjs/umd
    ...
    */
    ...
    function peek ( el, fn, scope ) {
        ...
        if ( isHidden ) {// save orig styles and set temp styles:
    ...
    // device['width'] = deviceW;
    // device['height'] = deviceH;
    // viewport['width'] = viewportW;
    // viewport['height'] = viewportH;
    
    api['viewportW'] = viewportW;
    api['viewportH'] = viewportH;
    //api['documentW'] = documentW;
    //api['documentH'] = documentH;
    api['deviceW'] = deviceW;
    api['deviceH'] = deviceH;
    // api['deviceMax'] = deviceMax;
    // api['deviceMin'] = deviceMin;
